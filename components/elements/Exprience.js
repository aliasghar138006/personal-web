...
function Exprience({title , descriptions , startDate , endDate=0 , icon}) {
    return (
        ...
        <div className='w-[70%]'>
            ...
            <span className='absolute top-[5px] left-[5px] bg-green-500 px-3 rounded-sm'>از {startDate}  تا {!endDate ? 'کنون' : endDate}</span>
        </div>
